...
if (( $# !=0 )); then
    echo "usage: bash receive"
    exit 1
fi

num_simulated_connections=$1

echo "Running test receive_patchy.sh."
echo "..."
...
tftp localhost 3490 -m octet -c put beejs_guide.html ./test_dir/beejs_guide.html > /dev/null 2>&1 &
wait $!
...
if [[ -z $differences ]]; then
	...
	echo "..."
	echo "Test receive_patchy.sh passed."
else
	echo $differences
	echo "..."
	...
	echo "..."
	echo "Test receive_patchy.sh failed."
fi

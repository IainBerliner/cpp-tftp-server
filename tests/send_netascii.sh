...
echo "Running test send_netascii.sh."
echo "..."
...
tftp -m netascii localhost 3490 -c get beejs_guide.html > /dev/null 2>&1 &
cd ..
...
if [[ -z $differences ]]; then
	...
	echo "..."
	echo "Test send_netascii.sh passed."
else
	echo $differences
	echo "..."
	...
	echo "..."
	echo "Test send_netascii.sh failed."
fi
